...
This document describes the **Bioschemas-based metadata model** and the **outputs generated by the ppi_benchmark_fair.py script**. The pipeline produces FAIR, machine-readable JSON-LD metadata for the *ELIXIR 3D-BioInfo Benchmark for Protein–Protein Interfaces*.
