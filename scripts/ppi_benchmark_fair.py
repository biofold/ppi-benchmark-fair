...
class PPIBenchmarkProcessor:
    ...
    def __init__(self, csv_url: str, mmcif_base_url: str, pdb_base_url: str, 
                 ...
                 fetch_pdb_metadata: bool = False, pdb_api_base_url: str = "https://data.rcsb.org/rest/v1/core",
    ...
    def fetch_pdb_structure_metadata_robust(self, pdb_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            entry_url = f"{self.pdb_api_base_url}/entry/{pdb_id.upper()}"
            ...
            if metadata.get("entity_ids"):
                ...
                for entity_id in metadata["entity_ids"]:
                    try:
                        entity_url = f"{self.pdb_api_base_url}/polymer_entity/{pdb_id.upper()}/{entity_id}"
            ...
            # APPROACH 3: If still no sequences, try alternative endpoints
    ...
    def enrich_protein_with_pdb_metadata(self, interface: ProteinInterface) -> Dict[str, Any]:
        ...
        # Fetch comprehensive metadata including ALL sequences
    ...
    def _add_pdb_metadata_to_protein_markup(self, protein_markup: Dict[str, Any], 
        ...
        # Extract structure and entity metadata
        structure_meta = pdb_metadata.get("structure_metadata", {})
        
        # Create a new additionalProperty entry for PDB metadata
        ...
        if structure_meta.get("sequences"):
            ...
            for chain_id, sequence in structure_meta["sequences"].items():
                # For display, truncate long sequences
                #if len(sequence) > 50:
                #    seq_display = sequence[:50] + "..."
                #else:
        ...
        # Add taxonomic information to protein markup if organism is available
