        ...
        <body>
            ...
            <header>
                    <div class="header-content">
                        ...
                        <h4 style="color:white;"><strong>ELIXIR Protein-Protein Interaction
                          Benchmark</strong></h4>
                        <!--
            ...
            <footer>
                <div class="container">
                    <div class="footer-content">
                        Comprehensive evaluation of FAIR principles compliance for scientific data repositories
                    </div>
                    <div class="footer-content">
...
/
        ...
        html_content += '''
            ...
            <footer>
                <div class="container">
                    <div class="footer-content">
                        Comprehensive evaluation of FAIR principles compliance for scientific data repositories</div>
                        <div class="footer-content">
                <a href="https://github.com/biofold/ppi-benchmark-fair">
                <img src="https://img.shields.io/badge/FAIR_Score-87.5%2F100-brightgreen" alt="FAIR Score: 87.5/100"></a>
                <a href="https://creativecommons.org/licenses/by/4.0/">
